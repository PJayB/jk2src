...
typedef struct interface_export_s
{
	...
	int				(*_I_ReadSaveData)( unsigned long chid, void *address, int length, void **addressptr/* = NULL*/ );
	int				(*I_LinkEntity)( int entID, CSequencer *sequencer, CTaskManager *taskManager );

	inline int		I_ReadSaveData( unsigned long chid, void *address, int length, void **addressptr = NULL )
	{
